  ...
  return (
    <div className="form-group">
      ...
      >
        ...
        <option value="Formal">正式 - 遵循学术标准，使用专业语言和结构</option>
        <option value="Analytical">分析性 - 批判性评估和详细检查数据与理论</option>
        <option value="Persuasive">说服性 - 说服读者接受特定观点或论点</option>
        ...
        <option value="Comparative">比较性 - 对比不同理论、数据或方法，突出异同</option>
        <option value="Speculative">推测性 - 探索假设和潜在影响或未来研究方向</option>
        <option value="Reflective">反思性 - 思考研究过程和个人见解或经验</option>
        <option value="Narrative">叙事性 - 通过讲故事来说明研究发现或方法论</option>
        ...
        <option value="Simple">简单 - 为年轻读者编写，使用基础词汇和清晰解释</option>
        <option value="Casual">休闲 - 对话式轻松风格，便于日常阅读</option>
      </select>
    </div>
  );
}