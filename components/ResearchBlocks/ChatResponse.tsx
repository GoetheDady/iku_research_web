...
export default function ChatResponse({ answer, metadata }: ChatResponseProps) {
    ...
    return (
      <div className="container flex h-auto w-full shrink-0 gap-4 bg-white backdrop-blur-md shadow-lg rounded-lg p-5">
        <div className="w-full">
          <div className="flex items-center justify-between pb-3">
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center w-6 h-6 rounded-md bg-[#238580]">
              ...
              <h3 className="text-sm font-medium text-[#4D4D4D]">回答</h3>
            </div>
            <button 
            ...
            >
              <img
                src="/deep_research_show/img/copy-white.svg"
                alt="copy"
                width={20}
                height={20}
          ...
          {hasWebSources && webSources.length > 0 && (
            <div className="mt-4 pt-3">
              <div className="flex items-center gap-2 mb-2">
                <div className="flex items-center justify-center w-5 h-5 rounded-md bg-[#238580]">
                ...
                <span className="text-xs font-medium text-[#238580]">新来源</span>
              </div>
