...
const AccessReport: React.FC<AccessReportProps> = ({ accessData, chatBoxSettings, report, onShareClick }) => {
  ...
  return (
    <div className="rounded-lg bg-white backdrop-blur-md shadow-lg py-4 px-4 pt-5">
      <div className="flex items-center justify-end">
        {/* <h3 className="text-lg font-bold text-[#4D4D4D]">获取您的研究报告</h3> */}
        ...
        <div className="flex flex-wrap justify-center gap-3 ">
          ...
          {accessData.docx && (
            <a 
              ...
              className="bg-blue-500 text-white font-medium uppercase text-xs px-6 py-auto h-[24px] rounded-lg shadow-md hover:shadow-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-400/50 transform hover:scale-105 transition-all duration-200 flex items-center gap-2"
              target="_blank"
              rel="noopener noreferrer">
              {/* <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* {chatBoxSettings?.report_type === 'research_report' && accessData.json && (
            <a
              ...
              className="bg-[#238580] text-white font-medium uppercase text-sm px-6 py-3 rounded-lg shadow-md hover:shadow-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 transform hover:scale-105 transition-all duration-200 flex items-center gap-2"
              target="_blank"
              rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
