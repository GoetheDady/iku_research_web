...
export default function Sources({
  ...
  if (compact) {
    ...
    return (
      <div className="max-h-[200px] overflow-y-auto scrollbar-thin scrollbar-thumb-[#238580] scrollbar-track-[#EEF0F4]">
  ...
  return (
    <div className="container h-auto w-full shrink-0 rounded-lg bg-white backdrop-blur-md shadow-lg p-5">
      <div className="flex items-start gap-4 pb-3 lg:pb-3.5">
        <img src="/deep_research_show/img/browser.svg" alt="sources" width={24} height={24} />
