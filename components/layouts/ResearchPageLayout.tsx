    ...
    <main className="flex min-h-screen flex-col">
      ...
      {showScrollButton && showResult && (
        <button
          ...
          className="fixed bottom-8 right-8 flex items-center justify-center w-12 h-12 text-white bg-gradient-to-br from-green-500 to-green-600 rounded-full hover:from-green-600 hover:to-green-700 transform hover:scale-105 transition-all duration-200 shadow-lg z-50 backdrop-blur-sm border border-green-400/20"
        >
          <svg 
