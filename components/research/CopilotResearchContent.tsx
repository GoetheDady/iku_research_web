...
export default function CopilotResearchContent({
  ...
  const [researchPanelWidth, setResearchPanelWidth] = useState(70); // percentage
  ...
  return (
    <div 
      ref={containerRef}
      className="flex flex-col lg:flex-row w-full h-screen gap-1 px-2 lg:px-2 relative overflow-hidden"
    >
      ...
      <div 
        ...
        data-panel="research"
        className={`w-full ${isCopilotVisible ? '' : 'lg:w-full'} h-full overflow-hidden flex flex-col bg-white backdrop-blur-sm rounded-lg ${!resizingActive ? 'transition-width duration-300' : ''}`}
      ...
      {isCopilotVisible && (
        <div
          className={`hidden lg:flex flex-col items-center justify-center w-1 h-full cursor-col-resize ${resizingActive ? 'bg-teal-500/50' : 'bg-white hover:bg-teal-500/30'} transition-colors duration-150 active:bg-teal-500/50 z-10 mx-0.5`}
      ...
      {isCopilotVisible && (
        <div 
          ref={chatPanelRef}
          data-panel="chat"
          className={`w-full h-1/2 lg:h-full overflow-hidden flex flex-col bg-white backdrop-blur-sm rounded-lg shadow-lg ${!resizingActive ? 'transition-width duration-300' : ''} ${
