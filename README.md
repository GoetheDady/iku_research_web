...
For packaging and deployment scripts details:
- [scripts/README.md](./scripts/README.md) - Packaging and deployment guide
- [scripts/pack-deploy.js](./scripts/pack-deploy.js) - Main packaging script
- [scripts/server-deploy.sh](./scripts/server-deploy.sh) - Server-side automation script
...
- ✅ **PM2 Process Management**: Zero-downtime restarts, auto-recovery
- ✅ **Server-side Dependency Installation**: Cross-platform compatibility
- ✅ **Environment Management**: Separate prod/dev configurations
